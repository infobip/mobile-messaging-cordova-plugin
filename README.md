...
3. Add MobileMessaging plugin to your project, run in terminal:
    ```bash
    $ cordova plugin add https://github.com/infobip/mobile-messaging-cordova-plugin.git#0.1.14 --save
    ```
